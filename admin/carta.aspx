<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admpri.master" AutoEventWireup="true" CodeFile="carta.aspx.cs" Inherits="admin_carta" %>
                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <asp:TextBox ID="txtnombre" class="form-control col-md-7 col-xs-12" runat="server"></asp:TextBox>

                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Descripción del Producto <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <asp:TextBox ID="txtdescrip" class="form-control col-md-7 col-xs-12" runat="server"></asp:TextBox>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Precio de Elaboración</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <asp:TextBox ID="txtprecioelab" type="number" class="form-control col-md-7 col-xs-12" runat="server"></asp:TextBox>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Precio de Venta</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <asp:TextBox ID="txtprecioventa" type="number" class="form-control col-md-7 col-xs-12" runat="server"></asp:TextBox>
                        </div>
                      </div>
                     ...
                     <div class="form-group">  
                        ...
                        <div class="col-md-3 col-sm-5 col-xs-12">
                            <asp:Image ID="img" CssClass="image" runat="server" Width="100%" Height="250px" />
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-2 col-xs-12 ">
                                <asp:LinkButton ID="btnconfirmar"  CssClass="btn btn-primary" runat="server" Text="Confirmar" OnClick="btnconfirmar_Click1"><i class="mdi-action-done left"></i>Confirmar</asp:LinkButton>
                                <br /> <br /><asp:LinkButton ID="btnlimpiar"  CssClass="btn btn-primary" runat="server" Text="Confirmar" OnClick="limpiarimg_Click"><i class="mdi-action-delete left"></i>Limpiar</asp:LinkButton>
                            </div>
                        </div>
                    </div>
...
<%-- <asp:AsyncPostBackTrigger ControlID="dgvproductos" EventName="OnSelectedIndexChanged" />
                 <asp:AsyncPostBackTrigger ControlID="dgvproductos" EventName="OnRowDataBound" />--%>
